...
import { BackpackIcon, Check, ChevronLeft, ChevronRight, ListIcon, ListRestartIcon, LucideListRestart, MoveLeftIcon, Play, TimerResetIcon } from "lucide-react";
          ...
          <div className="flex flex-col h-screen bg-[#1c1d1f] text-white">
               ...
               <div className="flex items-center justify-between p-4 bg-[#1c1d1f] border-b border-gray-700">
                    <div className="flex items-center space-x-4">
                         ...
                         <div className="text-lg font-bold hidden md:block w-full text-center">
                    ...
                    >
                         <Tabs defaultValue="content" className="h-full flex flex-col">
                              <TabsList className="grid bg-[#1c1d1f] w-full grid-cols-2 p-0 h-14">
                                   <TabsTrigger
                                        value="content"
                                        className=" text-black rounded-none h-full text-md"
                                   >
                                        Course Content
                                   </TabsTrigger>
                                   <TabsTrigger
                         ...
                         <DialogHeader>
                              ...
                              <DialogDescription className="flex flex-col gap-3">
                                   ...
                                   <div className="flex flex-row gap-3 mt-5 justify-between">
                                        <Button onClick={() => navigate("/student-courses")} className='bg-blue-700 hover:bg-blue-800'>
                                             {<ListIcon />} Courses
                                        </Button>
                                        <Button onClick={handleRewatchCourse} className='bg-blue-700 hover:bg-blue-800'>{<ListRestartIcon />}Rewatch </Button>
                                   </div>
                              </DialogDescription>
                         </DialogHeader>
                    </DialogContent>
